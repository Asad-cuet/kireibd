...
class OrderController extends Controller
{
    ...
    public function add_new_order()
    {
        ...
        return view('backend.sales.all_orders.order_form', compact('categories', 'users'));
    }

    static function new_order_store(Request $request)
    {
    ...
    public function productFilter(Request $request)
    {
        ...
        return view('backend.sales.all_orders.cart_items', compact('product_ids'));
    }
    ...
    public function all_orders_show($id)
    {
        ...
        if($order_shipping_address!=null){
            $delivery_boys = $delivery_boys->where('city', $order_shipping_address->city);
        }
        
        $delivery_boys=$delivery_boys->get();
    ...
    public function all_orders_edit($id)
    {
      ...
      // return $shipping_address;
        ...
        return view('backend.sales.all_orders.edit', compact('order', 'delivery_boys', 'shipping_address'));
    }

    public function all_orders_update(Request $request, $id)
    {
    ...
    public function edit($id)
    {
        $order = Order::findOrFail($id);
        $lang = $request->lang;
        return view('backend.sales.all_orders.edit', compact('order','lang'));
    }
