    ...
    public function upload(Request $request){
        ...
        if($request->hasFile('aiz_file')){
            ...
            if(isset($type[$extension])){
                ...
                $slug = preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', $upload->file_original_name));

                $file_count=Upload::where('file_name', 'uploads/all/' . $slug . '.' . $extension)->count();
                ...
                $unique_file_name=$slug . '.' . $extension;

                $path = $request->file('aiz_file')->storeAs('uploads/all',$unique_file_name);
