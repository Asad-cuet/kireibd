...
class Product extends Model
{
    ...
    protected $fillable = [
        'name', 'added_by', 'user_id', 'brand_id', 'photos', 'thumbnail_img', 'video_provider', 'video_link', 
        'tags', 'key_ingredients', 'skin_types', 'good_for', 'short_description', 'guide', 'description', 'unit_price', 'purchase_price', 'variant_product', 'attributes', 'choice_options', 'unit', 'slug', 
