		...
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				<div class="uppy-modal-nav">
					<ul class="nav nav-tabs border-0">
						...
						<li class="nav-item">
							<a class="nav-link font-weight-medium text-dark active" data-toggle="tab" href="#aiz-upload-new">{{ translate('Upload New') }}</a>
						</li>
					</ul>
				</div>
			...
			<div class="modal-body">
				<div class="tab-content h-100">
					...
					<div class="tab-pane h-100 active" id="aiz-upload-new">
