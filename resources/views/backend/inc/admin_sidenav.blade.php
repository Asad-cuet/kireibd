                ...
                @if(Auth::user()->user_type == 'admin' || in_array('23', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Doctors Appointment') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('doctors') }}" class="aiz-side-nav-link {{ areActiveRoutes(['doctors'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Doctors') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('doctors.create') }}" class="aiz-side-nav-link {{ areActiveRoutes(['doctors.create'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Add Doctor') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('blog-category.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['blog-category.create', 'blog-category.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Appoinments') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
