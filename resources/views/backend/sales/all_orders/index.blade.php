...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="col text-right">
            <a href="{{ route('add_new_order') }}" class="btn btn-circle btn-info">
...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
    ...
    <!--                    <td>
                        ...
                        <td>
                        <a href="{{route('all_orders.edit', encrypt($order->id))}}" title="{{ translate('Edit') }}"> {{ $order->code }} </a>
                        </td>
                        <td>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="{{route('all_orders.edit', encrypt($order->id))}}" title="{{ translate('Edit') }}">
