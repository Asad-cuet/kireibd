    ...
    <form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-8"> -->
                                <input type="hidden" class="form-control" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="pc">
                            <!-- </div>
                        </div> -->
                        <!-- <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Minimum Purchase Qty')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8"> -->
                                <input type="hidden" lang="en" class="form-control" name="min_qty" value="1" min="1" required>
                            <!-- </div>
                        </div> -->
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price"  onkeyup="updatePrice('unit_price')" id="unit_price"class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Purchase price') }}" name="purchase_price"   id="purchase_price" class="form-control" onkeyup="updatePrice('purchase_price')">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01" placeholder="{{ translate('Discount') }}" name="discount" id="discount" value="0" class="form-control" onkeyup="updatePrice('discount')">
                            </div>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-9"> -->
                                <input type="hidden" placeholder="{{ translate('External link button text') }}" name="external_link_btn" class="form-control">
                                <!-- <small class="text-muted">{{translate('Leave it blank if you do not use external site link')}}</small>
                            </div>
                        </div> -->
                        <br>
                ...
                <div class="card">
                    <div class="card-header" id="product-short-description" >
                        <h5 class="mb-0 h6 ps-dsc">
                            <button class="btn product-sdec-btn" type="button"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                {{translate('Product Short Description')}}
                             </button>
                        </h5>
                    </div>
                    <div class="card-body collapse" id="collapseOne" aria-labelledby="product-short-description" style="transition-duration: 0.5s;">
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header" id="product-description">
                        <h5 class="mb-0 h6 ps-dsc">
                            <button class="btn product-sdec-btn" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                {{translate('Product Description')}}
                            </button>
                        </h5>
                    </div>
                    <div class="card-body collapse" id="collapseTwo"  aria-labelledby="product-description" style="transition-duration: 0.5s;">
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header" id="product-guide">
                        <h5 class="mb-0 h6 ps-dsc">
                            <button class="btn product-sdec-btn" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                {{translate('Product Guide')}}
                            </button>
                        </h5>
                    </div>
                    <div class="card-body collapse" id="collapseThree" aria-labelledby="product-guide" style="transition-duration: 0.5s;">
                        <div class="form-group row">
                ...
                <!-- <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8"> -->
                                <input type="hidden" class="form-control" name="meta_title" placeholder="{{ translate('Meta Title') }}">
                             <!-- </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Description')}}</label>
                            <div class="col-md-8"> -->
                                <textarea name="meta_description" rows="8" class="form-control" style="display:none"></textarea>
                            <!-- </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="btn-group mt-2 mr-2" role="group" aria-label="Third group">
                                            <button type="submit" name="button" value="preview" class="btn btn-info action-btn">{{ translate('Preview') }}</button>
                                        </div>
                                        <div class="btn-group mt-2 mr-2" role="group" aria-label="Third group">
