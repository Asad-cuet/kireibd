...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/add-more-choice-option', 'add_more_choice_option')->name('products.add-more-choice-option');
         ...
         Route::get('/published-product-filter', 'all_products')->name('published.product_filter');
    });
...
Route::controller(AppointmentController::class)->group(function () {
    ...
    Route::get('/doctors/create', 'doctors_create')->name('doctors.create');
    Route::post('/doctors/add', 'doctors_add')->name('doctors.add');
    Route::get('/doctors/edit/{doctor_id}', 'doctors_edit')->name('doctors.edit');
    Route::post('/doctors/update/{doctor_id}', 'doctors_update')->name('doctors.update');
    Route::get('/doctors/delete/{doctor_id}', 'doctors_delete')->name('doctors.delete');
    ...
    Route::controller(OrderController::class)->group(function () {
        // All Orders
        Route::post('/orders/custom-store', 'custom_store')->name('orders.custom-store');
        Route::get('/all_orders', 'all_orders')->name('all_orders.index');
        Route::get('/all_orders/{id}/show', 'all_orders_show')->name('all_orders.show');
        Route::get('/all_orders/{id}/edit', 'all_orders_edit')->name('all_orders.edit');
        Route::post('/all_orders/{id}/update', 'all_orders_update')->name('all_orders.update');
        Route::get('/add-new-order', 'add_new_order')->name('add_new_order');
        Route::post('/new-order-store', 'new_order_store')->name('new_order_store');
        Route::post('/add-new-order/product-filter', 'productFilter')->name('add_new_order.product_filter');
